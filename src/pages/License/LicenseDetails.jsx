    ...
    import schemaJson from "./License.schema.json";
    import { listLicenses } from "../../services/License.service";
    
    const LicenseDetails = ({ apiURL = "" }) => {
      ...
      return (
        <div className="pageDetailView flex-column d-flex overflow-auto">
          ...
          <ViewDetails getDetails={listLicenses} apiURL={apiURL} modelName={schemaJson?.name} schemaJson={schemaJson} />
        </div>
      );
    };
